...
export default function ProductCategoriesPage() {
  ...
  async function handleDelete(id: string) {
    if (!confirm('Xoá danh mục này? Các sản phẩm thuộc danh mục sẽ không bị xoá.')) return
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b">
              <tr>
                ...
                <th className="text-center px-4 py-3 font-medium text-gray-600 w-24">Sản phẩm</th>
            ...
            <tbody className="divide-y">
              {items.map(item => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-center text-gray-600">{item._count?.products ?? 0}</td>
