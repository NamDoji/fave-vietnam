...
export default function Footer() {
  ...
  const serviceLinks = [
    { label: 'Điều hòa trung tâm', href: '/dich-vu/bao-tri-dieu-hoa' },
    { label: 'Thông gió công nghiệp', href: '/dich-vu/bao-duong-chiller' },
    { label: 'Hệ thống lạnh', href: '/dich-vu/sua-chua-hvac' },
    { label: 'VRV/VRF', href: '/dich-vu/cai-tao-nang-cap' },
    { label: 'Xử lý không khí sạch', href: '/dich-vu/ve-sinh-cong-nghiep' },
    { label: 'Bảo trì bảo dưỡng', href: '/dich-vu/thiet-ke-hvac' },
  ]
